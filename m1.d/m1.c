...
void RxODE_mod_m1_dydt(unsigned int neq, double t, double *__zzStateVar__, double *__DDtStateVar__)
{
double
	C2,
	centr,
	...
	__DDtStateVar__[3] = InfusionRate[3] + Kin - Kout *( 1 - C2 /( EC50 + C2)) * eff;
    dadt_counter++;
}

// prj-specific derived vars
void RxODE_mod_m1_calc_lhs(double t, double *__zzStateVar__, double *lhs) {
double
	C2,
	centr,
	V2,
